...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features: int, num_output_features: int) -> None:
        ...
        self.add_module('pool', nn.AvgPool2d(kernel_size=(1, 2), stride=2))
...
class DenseNet(nn.Module):
    ...
    def __init__(
        ...
        self.features = nn.Sequential(OrderedDict([
            ...
            # XXX padding????????
            ('pool0', nn.MaxPool2d(kernel_size=(1, 3), stride=2, padding=(0,1))),
            #('pool0', nn.MaxPool2d(kernel_size=(3, 3), stride=2, padding=1)),
        ]))
