...
class SiameseARDSClassifier(nn.Module):
    def __init__(self, pretrained_network, sub_batch_size):
        ...
        try:
            self.pretrained_network.linear_final = nn.Linear(self.pretrained_network.time_layer_hidden_units, 2)
...
class SiameseCNNLinearNetwork(nn.Module):
    def __init__(self, breath_block, sub_batch_size):
        super(SiameseCNNLinearNetwork, self).__init__()
