...
All code taken from torchvision.models.detection.retinanet and very minorly modified.
Honestly I probably could have stuck with polymorphism and everything would've been
just fine.
"""
import math
