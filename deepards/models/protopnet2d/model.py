...
from deepards.models.protopnet2d.receptive_field import compute_proto_layer_rf_info_v2
...
class PPNet(nn.Module):
    ...
    def __init__(self, features, img_size, prototype_shape,
                 ...
                 add_on_layers_type='bottleneck', bank_size=1):
...
def construct_PPNet(base_architecture, img_size=224,
