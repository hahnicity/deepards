        ...
        do
            ...
            do
                ...
                do
                    ...
                    ts python train_ards_detector.py -p /fastdata/deepards/padded_breath_by_breath_with_flow_time_features-nb100-kfolds.pkl -dt  padded_breath_by_breath_with_flow_time_features -n cnn_lstm --cuda -rip ${rip} -b ${bs} -e 15 --no-print-progress --kfolds 5 -rdc
                done
            done
        done
    done
