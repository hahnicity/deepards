...
class BaseTraining(object):
    ...
    def __init__(self, parser_args):
        ...
        if self.args.cuda:
            ...
            single_gpu = torch.device('cuda:{}'.format(self.args.cuda_device))
...
def main():
    ...
    parser.add_argument('--debug', action='store_true', default=None, help='debug code and dont train')
    ...
    parser.add_argument('--no-train', action='store_true', default=None, help='Dont train model, just evaluate for inference')
    ...
    parser.add_argument('--unshuffled', action='store_true', default=None, help='dont shuffle data for lstm processing')
    ...
    parser.add_argument('--plot-untiled-disease-evol', action='store_true', default=None, help='Plot the our ARDS/non-ARDS predictions by hour')
    parser.add_argument('--plot-tiled-disease-evol', action='store_true', default=None, help='Plot the our ARDS/non-ARDS predictions by hour but in tiled format grouped by TPs/TNs/FPs/FNs')
    parser.add_argument('--plot-dtw-with-disease', action='store_true', default=None, help='Plot DTW with ARDS/non-ARDS predictions by hour')
